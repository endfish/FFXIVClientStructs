...
public unsafe partial struct PacketDispatcher {
    ...
    [MemberFunction("48 89 5C 24 ?? 57 48 83 EC ?? 0F B7 5A 08 48 8B FA")]
    ...
    [MemberFunction("40 53 48 83 EC 20 48 8B D9 E8 ?? ?? ?? ?? 48 8B D3 48 8B C8 48 83 C4 20 5B E9 ?? ?? ?? ?? CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC 40 53 48 83 EC 20 48 8B D9 E8 ?? ?? ?? ?? 48 8B C8 E8 ?? ?? ?? ?? 48 85 C0 74 10")]
