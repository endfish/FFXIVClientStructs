...
public unsafe partial struct UIModule {
    ...
    // CN September offsets verified against UIModule virtual getters and embedded module layout.
    [FieldOffset(0xBB150)] internal UI3DModule UI3DModule;
    [FieldOffset(0xD2690)] internal RaptureAtkModule RaptureAtkModule;
    [FieldOffset(0xFD000)] internal InfoModule InfoModule;
    [FieldOffset(0xFEC78)] internal UIModuleHelpers UIModuleHelpers;
    [FieldOffset(0xFECC8)] public Utf8String AddonSheetName;

    [FieldOffset(0xFED38)] public Utf8String UIColorSheetName;

    [FieldOffset(0xFEDB0)] public Utf8String CompletionSheetName;
    [FieldOffset(0xFEE18)] public Utf8String CompletionOpenIconMacro;
    [FieldOffset(0xFEE80)] public Utf8String CompletionCloseIconMacro;
    [FieldOffset(0xFEEE8)] public Utf8String NewLineMacro;
    [FieldOffset(0xFEF50)] public Utf8String LastTalkName;
    [FieldOffset(0xFEFB8)] public Utf8String LastTalkText;
    [FieldOffset(0xFF020)] internal UIInputData UIInputData;
    [FieldOffset(0xFFA50)] internal UIInputModule UIInputModule;
